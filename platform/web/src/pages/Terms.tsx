 ...
 * and billing comes after G2 (§19.1 D5). The operator and the age limit are
 * the owner's decisions (2026-09-25, RED-236).
 *
...
export function Terms() {
  return (
    <LegalPage title="Terms of use" updated={TERMS_UPDATED}>
      <h2>The service</h2>
      <p>
        Ogre MCP is run by Red Pine Software. It connects your game to an AI agent you choose, such as Claude or ChatGPT. The agent
        reads your game state and suggests what to do. It never acts in the game: you make every move.
      </p>

      <h2>Who can use it</h2>
      <p>You must be 13 or older to use the service.</p>
