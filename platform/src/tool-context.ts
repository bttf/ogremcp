...
/** The history limit and the result size cap (*proposed*, §0). `config.ts` reads them from the environment. */
...
export const DEFAULT_TOOL_CONTEXT: ToolContextSettings = { maxHistoryLimit: 100, maxResultBytes: 40 * 1024 };
