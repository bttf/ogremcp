 ...
 * gating. An unknown or ambiguous `character` rejects with an error whose
 * message is user-facing (§10.5). A handler lets it propagate: the platform
 * turns it into an `isError` result.
 */
